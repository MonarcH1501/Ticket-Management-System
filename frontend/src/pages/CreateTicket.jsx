...
import { PRIMARY_BORDER, SHADOW_SUBTLE } from "../theme/colors"
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "32px 24px", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 24, fontWeight: 800, color: "#0c4a6e" }}>Create Ticket</div>
      ...
      <div style={{
        ...
        boxShadow: SHADOW_SUBTLE, padding: "28px 32px"
      }}>
